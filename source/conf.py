...
latex_documents = [
    (master_doc, 'stack.tex', 'stack Documentation',
     'Ryan Kung', 'manual'),
]
...
man_pages = [
    (master_doc, 'stack', 'stack Documentation',
     [author], 1)
]
